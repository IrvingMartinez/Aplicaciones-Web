...
<div class="container">
	<div class="span10 offset1">
		...
		<form class="form-horizontal" action="/admin/Products/update/{id}" method="POST">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="stock" type="text"  placeholder="Stock" value="{stock}">
					<span class="help-inline" style="display: none"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input name="stock_min" type="text"  placeholder="Stock_min" value="{stock_min}">
					<span class="help-inline" style="display: none"></span>
				</div>
			</div>
			<div class="control-group">
